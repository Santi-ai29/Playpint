...
- Modo original exposto no registry: `most_likely`.
- O MVP tambem expoe `what_would_you_do` como jogo independente.
...
- O admin pode trocar a pergunta antes da votacao e remover jogadores antes de comecar.
...
- variar a estrutura das frases para o deck nao parecer uma repeticao mecanica;
