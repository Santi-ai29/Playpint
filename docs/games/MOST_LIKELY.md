...
- Setup antes de jogar: escolher numero de jogadores, editar nomes e definir rondas de 0 a 12 (`0` = livre na UI).
...
- oferecer um ecra antes de comecar com numero de jogadores, nomes editaveis e numero de rondas;
...
- antes de comecar, o host ve um painel compacto para configurar jogadores, nomes e rondas;
