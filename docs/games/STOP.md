...
logo `STOP`, Playpint por baixo e fundo fluido nitido nas transicoes, sorteia a
letra num slot visual limpo, faz uma contagem `3 2 1` animada e abre a ronda
ativa com fundo limpo, review por categoria e pontos limpos.
